...
export default class UpgradeManager {
    game: UpgradeInterface
    usedUpgrades: Upgrade[]
    _upgrades: Upgrade[]
    
    constructor(game: UpgradeInterface, upgrades=[], usedUpgrades=[]){
        this.game = game
    ...
    initUpgrades = ()=>{
        var u1 = new Upgrade({
            ...
            trigger: ()=>{return this.game.getTotalMoney() > .74},
        })
        ...
        var u2 = new Upgrade({
            ...
            trigger: ()=>{
                return u1.used && this.game.getTotalMoney() >= .5
            },
            effect: ()=>{
                this.game.spendMoney(1)
                this.game.setUserClickVal(.05)
            },
            cost: ()=>{return this.game.getMoney()>= 1}
        })
        ...
        var u3 = new Upgrade({
            ...
            trigger: ()=>{return u2.used && this.game.getTotalMoney() >= 2},
            effect: ()=>{
                this.game.spendMoney(4)
                this.game.setUserClickVal(.10)
            },
            cost: ()=>{return this.game.getMoney()>= 4}
        })
        ...
        var u4 = new Upgrade({
            ...
            trigger: ()=>{return u3.used && this.game.getTotalMoney() >= 10},
            effect: ()=>{
                this.game.spendMoney(10)
                this.game.setUserClickVal(.25)
            },
            cost: ()=>{return this.game.getMoney()>= 10}
        })
        ...
        var u5 = new Upgrade({
            ...
            trigger: ()=>{return u1.used && this.game.getTotalMoney() >= 10},
            effect: ()=>{
                this.game.spendMoney(10)
        ...
        var u6 = new Upgrade({
            ...
            trigger: ()=>{return u5.used && u2.used && this.game.getTotalMoney() >= 25},
            effect: ()=>{
                this.game.spendMoney(25)
                this.game.setWorkerClickVal(.05)
            },
            cost: ()=>{return this.game.getMoney()>= 25}
        })
        ...
        var u7 = new Upgrade({
            ...
            trigger: ()=>{return u4.used && this.game.getTotalMoney() >= 25},
            effect: ()=>{
                this.game.spendMoney(25)
        ...
        var u8 = new Upgrade({
            ...
            trigger: ()=>{return u6.used && u3.used && this.game.getTotalMoney() >= 50},
            effect: ()=>{
                this.game.spendMoney(50)
                this.game.setWorkerClickVal(.10)
            },
            cost: ()=>{return this.game.getMoney()>= 50}
        })
        ...
        var u9 = new Upgrade({
            ...
            trigger: ()=>{return u4.used && u8.used && this.game.getTotalMoney() >= 100},
            effect: ()=>{
                this.game.spendMoney(100)
                this.game.setWorkerClickVal(.25)
            },
            cost: ()=>{return this.game.getMoney()>= 100}
        })
        ...
        var u10 = new Upgrade({
            ...
            trigger: ()=>{return u5.used && this.game.getNumWorkers() >= WORKERS_PER_MANAGER && this.game.getTotalMoney() >= 100},
            effect: ()=>{
                this.game.spendMoney(100)
        ...
        var u11 = new Upgrade({
            ...
            trigger: ()=>{return u10.used && this.game.getNumWorkers() >= WORKERS_PER_MANAGER * MANAGERS_PER_MANAGER && this.game.getTotalMoney() >= 200},
            effect: ()=>{
                this.game.spendMoney(200)
                this.game.unlockMiddleManagers()
            },
            cost: ()=>{return this.game.getMoney()>= 200}
        })
        
        var u12 = new Upgrade({
            title: "Friends and Family Investment",
            description: "$200 - This counts as your birthday present too...",
            trigger: ()=>{return u5.used && this.game.getTotalMoney() >= 50},
            effect: ()=>{
        ...
        var u13 = new Upgrade({
            ...
            trigger: ()=>{return u7.used && u9.used && this.game.getTotalMoney() >= 150},
            effect: ()=>{
                this.game.spendMoney(150)
                this.game.setWorkerClickVal(.50)
            },
            cost: ()=>{return this.game.getMoney()>= 150}
        })
        ...
        var u14 = new Upgrade({
            ...
            trigger: ()=>{return u7.used && this.game.getTotalMoney() >= 50},
            effect: ()=>{
                this.game.spendMoney(50)
        ...
        var u15 = new Upgrade({
            ...
            trigger: ()=>{return u13.used && u14.used && this.game.getTotalMoney() >= 250},
            effect: ()=>{
                this.game.spendMoney(250)
                this.game.setWorkerClickVal(1)
            },
            cost: ()=>{return this.game.getMoney()>= 250}
        })
